...
//		String str = "很好用，不仅可以交到好多新朋友，而且聊天也非常完美，大家完全可以下载";
		String straTo = ToAnalysis.parse(str).toString();
		String straDi = DicAnalysis.parse(str).toString();
		String straIn = IndexAnalysis.parse(str).toString();
		String straNl = NlpAnalysis.parse(str).toString();
		CreateWordGroup.createWordGroup(straTo);
		CreateWordGroup.createWordGroup(straDi);
		CreateWordGroup.createWordGroup(straIn);
		CreateWordGroup.createWordGroup(straNl);
